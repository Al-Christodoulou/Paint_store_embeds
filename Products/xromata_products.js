const Products = [
	...
	*/
	...
	{
		name: "Acrylux",
		description: "Yπέρλευκο ακρυλικό χρώμα κορυφαίας ποιότητας και καλυπτικότητας με εξαιρετικές αντοχές στις αλλαγές των καιρικών συνθηκών, την υπεριώδη ακτινοβολία και την κιμωλίαση. Χάρη στην ειδική του σύνθεση, δε δημιουργούνται σκασίματα και ρωγμές στην επιφάνεια ακόμα και όταν εφαρμόζεται σε θερμοκρασία περιβάλλοντος άνω των 40ºC. Είναι υπέρλευκο και προσδίδει εξαιρετική καλυπτικότητα, υψηλή απόδοση και πολύ μεγάλη ευκολία στην εφαρμογή. Χρωματίζεται σε χιλιάδες αποχρώσεις σύμφωνα με το σύστημα χρωματισμού της Berling.",
		category: "Ακρυλικό Πλαστικό",
		amount: "750ml",
		image: "https://i.imgur.com/SoohHCW.png",
	},
	{
		name: "Petite",
