const Products = [
	...
	},
	{
		...
		description: "Χαρακτηρίζεται από μεγάλη υδαταπωθητικότητα, υψηλές μηχανικές αντοχές και χρωματική σταθερότητα. Επιπλέον, περιέχει ειδικά βακτηριοστατικά συστατικά, τα οποία δεν επιτρέπουν την ανάπτυξη βακτηριδίων στον αρμό. Δίνει λεία και γυαλιστερή τελική επιφάνεια. Κατάλληλος για πλάτος αρμών από 1 έως 8 mm. Διαθέσιμος σε 34 αποχρώσεις!",
		category: "Αρμόστοκος",
		amount: "4kg",
